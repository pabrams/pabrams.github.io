...
#show: cv.with(
  ...
  tagline: "Senior Software Developer · ASP.NET Web API / C# / VB.NET / SQL · Vue.js & Angular · 15+ Years Enterprise Government Systems · Justice-Domain (Legal Case Management) · TFS → Azure DevOps Transition & Agile SCRUM Leadership",
  contact: (
    "(819) 921-7192",
  ...
  summary: [Senior full-stack developer with 15+ years across the full SDLC, shipping web-based enterprise applications from front-end UI through service back ends and relational databases.],
  experience: (
    (
      org: "Abrams Software",
...
*Front-End:* JavaScript, TypeScript, HTML / CSS, React, Angular, Vue, Blazor, Knockout.js — responsive, WCAG AA / AODA accessible.
